...
_TEST_UTILS_SOURCE_COUNT=${#BASH_SOURCE[@]}
_TEST_UTILS_SCRIPT_INDEX=$((_TEST_UTILS_SOURCE_COUNT - 1))
_TEST_UTILS_SCRIPT_PATH="${BASH_SOURCE[$_TEST_UTILS_SCRIPT_INDEX]:-$0}"

# 报告相关变量
BASE_DIR=$(cd "$(dirname "$_TEST_UTILS_SCRIPT_PATH")" && pwd)
...
generate_report() {
    local script_name
    script_name="$(basename "$_TEST_UTILS_SCRIPT_PATH")"
