...
Use template from `E:/project/self.project/git-utils.sh/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `E:/project/self.project/git-utils.sh/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
