...
Reference full template: `D:/project/git-utils.sh/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/project/git-utils.sh/.claude/get-shit-done/templates/state.md`.
