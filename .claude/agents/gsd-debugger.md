...
<required_reading>
@D:/project/git-utils.sh/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/project/git-utils.sh/.claude
                  → checks D:/project/git-utils.sh/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/project/git-utils.sh/.claude/get-shit-done
                  → writes to D:/project/git-utils.sh/.claude/get-shit-done/hooks/
...
@D:/project/git-utils.sh/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @D:/project/git-utils.sh/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
