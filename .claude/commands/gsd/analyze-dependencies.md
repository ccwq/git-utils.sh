...
<execution_context>
@E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/analyze-dependencies.md
</execution_context>
...
<process>
Execute the analyze-dependencies workflow from @E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/analyze-dependencies.md end-to-end.
