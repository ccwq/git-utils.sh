...
<execution_context>
@D:/project/git-utils.sh/.claude/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @D:/project/git-utils.sh/.claude/get-shit-done/workflows/next.md end-to-end.
</process>
