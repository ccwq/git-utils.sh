...
Knowledge graph is disabled. To activate:
  ...
  node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
Project root: ${CWD}
gsd-tools path: D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs
...
4. **Write diff snapshot:**
   ```
   node \"D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
