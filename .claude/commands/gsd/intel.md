...
Intel system is disabled. To activate:
  ...
  node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
