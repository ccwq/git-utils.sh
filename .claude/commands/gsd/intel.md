...
Intel system is disabled. To activate:
  ...
  node E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs config-set intel.enabled true
...
```bash
node E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs intel query <term>
```
...
```bash
node E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs intel status
```
...
```bash
node E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs intel diff
```
...
Project root: ${CWD}
gsd-tools path: E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs
