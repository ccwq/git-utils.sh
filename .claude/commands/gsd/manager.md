...
<execution_context>
@D:/project/git-utils.sh/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @D:/project/git-utils.sh/.claude/get-shit-done/workflows/manager.md end-to-end.
