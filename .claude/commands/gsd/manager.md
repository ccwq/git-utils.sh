...
<execution_context>
@E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/manager.md
...
<process>
Execute the manager workflow from @E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/manager.md end-to-end.
