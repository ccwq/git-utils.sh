...
<execution_context>
@D:/project/git-utils.sh/.claude/get-shit-done/workflows/execute-phase.md
...
<process>
Execute the execute-phase workflow from @D:/project/git-utils.sh/.claude/get-shit-done/workflows/execute-phase.md end-to-end.
