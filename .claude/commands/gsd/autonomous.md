...
<execution_context>
@E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/autonomous.md
...
<process>
Execute the autonomous workflow from @E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/autonomous.md end-to-end.
