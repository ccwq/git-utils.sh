...
<execution_context>
@E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/quick.md
</execution_context>
...
<process>
Execute the quick workflow from @E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/quick.md end-to-end.
