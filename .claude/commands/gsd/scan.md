...
<execution_context>
@D:/project/git-utils.sh/.claude/get-shit-done/workflows/scan.md
</execution_context>

<process>
Execute the scan workflow from @D:/project/git-utils.sh/.claude/get-shit-done/workflows/scan.md end-to-end.
</process>
