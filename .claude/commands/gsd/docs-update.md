...
<execution_context>
@D:/project/git-utils.sh/.claude/get-shit-done/workflows/docs-update.md
</execution_context>
...
<process>
Execute the docs-update workflow from @D:/project/git-utils.sh/.claude/get-shit-done/workflows/docs-update.md end-to-end.
