...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = E:/project/self.project/git-utils.sh/.claude
                  → checks E:/project/self.project/git-utils.sh/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = E:/project/self.project/git-utils.sh/.claude/get-shit-done
                  → writes to E:/project/self.project/git-utils.sh/.claude/get-shit-done/hooks/
...
@E:/project/self.project/git-utils.sh/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @E:/project/self.project/git-utils.sh/.claude/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "E:/project/self.project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
