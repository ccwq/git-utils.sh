...
- Usage: Reference from command with `@E:/project/self.project/git-utils.sh/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to E:/project/self.project/git-utils.sh/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to E:/project/self.project/git-utils.sh/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
