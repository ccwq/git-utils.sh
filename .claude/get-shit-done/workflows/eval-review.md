...
```bash
AUDITOR_MODEL=$(node "D:/project/git-utils.sh/.claude/get-shit-done/bin/gsd-tools.cjs" resolve-model gsd-eval-auditor --raw)
```
...
```markdown
Read D:/project/git-utils.sh/.claude/agents/gsd-eval-auditor.md for instructions.
