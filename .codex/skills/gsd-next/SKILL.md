...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/next.md
</execution_context>

<process>
Execute the next workflow from @E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/next.md end-to-end.
</process>
