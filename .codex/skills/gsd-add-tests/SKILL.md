...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/add-tests.md
</execution_context>
...
<process>
Execute the add-tests workflow from @D:/project/git-utils.sh/.codex/get-shit-done/workflows/add-tests.md end-to-end.
