...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/code-review-fix.md
</execution_context>
...
Execute the code-review-fix workflow from @D:/project/git-utils.sh/.codex/get-shit-done/workflows/code-review-fix.md end-to-end.
