...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/new-milestone.md
...
<process>
Execute the new-milestone workflow from @E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/new-milestone.md end-to-end.
