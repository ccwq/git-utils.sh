...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/add-todo.md
</execution_context>
...
<process>
**Follow the add-todo workflow** from `@D:/project/git-utils.sh/.codex/get-shit-done/workflows/add-todo.md`.
