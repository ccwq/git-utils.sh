...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/fast.md
</execution_context>

<process>
Execute the fast workflow from @E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/fast.md end-to-end.
</process>
