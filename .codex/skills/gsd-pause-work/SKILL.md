...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/pause-work.md
</execution_context>
...
<process>
**Follow the pause-work workflow** from `@D:/project/git-utils.sh/.codex/get-shit-done/workflows/pause-work.md`.
