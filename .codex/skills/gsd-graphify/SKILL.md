...
Knowledge graph is disabled. To activate:
  ...
  node D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```
PREFLIGHT=$(node "D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs" graphify build)
```
...
4. **Write diff snapshot:**
   ```
   node \"D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs\" graphify build snapshot
   ```
