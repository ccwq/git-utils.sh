...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/note.md
...
<process>
Execute the note workflow from @D:/project/git-utils.sh/.codex/get-shit-done/workflows/note.md end-to-end.
