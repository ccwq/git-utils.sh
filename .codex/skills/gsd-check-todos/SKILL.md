...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@D:/project/git-utils.sh/.codex/get-shit-done/workflows/check-todos.md`.
