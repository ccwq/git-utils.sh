...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/check-todos.md
</execution_context>
...
<process>
**Follow the check-todos workflow** from `@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/check-todos.md`.
