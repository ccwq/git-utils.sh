...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/settings.md
</execution_context>

<process>
**Follow the settings workflow** from `@D:/project/git-utils.sh/.codex/get-shit-done/workflows/settings.md`.
