...
<execution_context>
@D:/project/git-utils.sh/.codex/get-shit-done/workflows/update.md
</execution_context>

<process>
**Follow the update workflow** from `@D:/project/git-utils.sh/.codex/get-shit-done/workflows/update.md`.
