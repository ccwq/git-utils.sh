...
<!-- For checkpoint task examples and patterns, see @D:/project/git-utils.sh/.codex/get-shit-done/references/checkpoints.md -->
...
See `D:/project/git-utils.sh/.codex/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/project/git-utils.sh/.codex/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/project/git-utils.sh/.codex/get-shit-done/workflows/verify-phase.md` for verification logic.
