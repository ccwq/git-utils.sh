...
<reference>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `E:/project/self.project/git-utils.sh/.codex/get-shit-done/references/user-profiling.md` to load:
