...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/insert-phase.md
</execution_context>
...
<process>
Execute the insert-phase workflow from @E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/insert-phase.md end-to-end.
