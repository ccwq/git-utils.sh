...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/do.md
...
<process>
Execute the do workflow from @E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/do.md end-to-end.
