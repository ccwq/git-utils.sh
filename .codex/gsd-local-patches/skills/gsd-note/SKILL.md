...
<execution_context>
@E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/note.md
...
<process>
Execute the note workflow from @E:/project/self.project/git-utils.sh/.codex/get-shit-done/workflows/note.md end-to-end.
