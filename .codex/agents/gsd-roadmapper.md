...
Reference full template: `E:/project/self.project/git-utils.sh/.codex/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `E:/project/self.project/git-utils.sh/.codex/get-shit-done/templates/state.md`.
