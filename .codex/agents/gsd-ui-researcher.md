...
Use template from `D:/project/git-utils.sh/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/project/git-utils.sh/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
