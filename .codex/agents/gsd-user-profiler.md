...
<reference>
@D:/project/git-utils.sh/.codex/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/project/git-utils.sh/.codex/get-shit-done/references/user-profiling.md` to load:
