...
@D:/project/git-utils.sh/.codex/get-shit-done/references/thinking-models-execution.md

**iOS app scaffolding:** If this plan creates an iOS app target, follow ios-scaffold guidance:
@D:/project/git-utils.sh/.codex/get-shit-done/references/ios-scaffold.md
...
@D:/project/git-utils.sh/.codex/get-shit-done/references/executor-examples.md
</deviation_rules>
...
**See @D:/project/git-utils.sh/.codex/get-shit-done/references/checkpoints.md**
...
```bash
node D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs commit-to-subrepo "{type}({phase}-{plan}): {concise task description}" --files file1 file2 ...
```
...
**Use template:** @D:/project/git-utils.sh/.codex/get-shit-done/templates/summary.md
...
node "D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs" roadmap update-plan-progress "${PHASE_NUMBER}"
...
```bash
node "D:/project/git-utils.sh/.codex/get-shit-done/bin/gsd-tools.cjs" state add-blocker "Blocker description"
```
</state_updates>
